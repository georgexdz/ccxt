...
func (self *Bitmax) InitDescribe() (err error) {
    ...
    func (self *Bitmax) FetchCurrencies (params map[string]interface{}) (ret interface{}, err error) {
    
assets, err := self.ApiFunc("publicGetAssets", params, nil, nil)
if err != nil {
return nil, err
}

margin, err := self.ApiFunc("publicGetMarginAssets", params, nil, nil)
if err != nil {
return nil, err
}

cash, err := self.ApiFunc("publicGetCashAssets", params, nil, nil)
if err != nil {
return nil, err
}
...
precision := self.SafeInteger2(currency,"precisionScale","nativeScale")
fee := self.SafeFloat2(currency,"withdrawFee","withdrawalFee")
...
func (self *Bitmax) FetchMarkets (params map[string]interface{}) (ret interface{}, err error) {
    
products, err := self.ApiFunc("publicGetProducts", params, nil, nil)
if err != nil {
return nil, err
}

cash, err := self.ApiFunc("publicGetCashProducts", params, nil, nil)
if err != nil {
return nil, err
}

futures, err := self.ApiFunc("publicGetFuturesContracts", params, nil, nil)
if err != nil {
return nil, err
}
...
func (self *Bitmax) FetchOrderBook (symbol string, limit int64, params map[string]interface{}) (orderBook interface{}, err error) {
...
response, err := self.ApiFunc("publicGetDepth", self.Extend(request,params), nil, nil)
if err != nil {
return nil, err
}
...
result, err := self.ParseOrderBook(orderbook,timestamp)
if err != nil {
return nil, err
}
...
func (self *Bitmax) ParseOrder (order interface{}, market interface{}) (result interface{}) {
...
timestamp := self.SafeInteger2(order,"timestamp","sendingTime")
...
filled := self.SafeFloat2(order,"cumFilledQty","cumQty")
...
func (self *Bitmax) CreateOrder (symbol string, typ string, side string, amount float64, price float64, params map[string]interface{}) (order map[string]interface{}, err error) {
...
err = errors.New(self.Id + " createOrder requires a stopPrice parameter for " + typ + " orders");
return
} else {
...
func (self *Bitmax) FetchOrder (id string, symbol string, params map[string]interface{}) (order interface{}, err error) {
...
func (self *Bitmax) FetchOpenOrders (symbol string, since int64, limit int64, params map[string]interface{}) (orders interface{}, err error) {
...
func (self *Bitmax) Sign (path string, api string, method string, params map[string]interface{}, headers interface{}, body interface{}) (ret interface{}, err error) {
